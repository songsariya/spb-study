...
import kr.ywpark.spb2.domain.posts.PostsRepository;
...
public class PostApiControllerTest {
    ...
    public void Posts_Regist() throws Exception {
        ...
        PostsSaveReqeustDto reqeustDto = PostsSaveReqeustDto.builder().title(title).content(content).author("songari").build();
